...
public class OthersAddEntryActivity extends BaseFeedActivity {

    private static int CATEGORY = 10;
    private DotCategory mDotCategory;

    private EditText othersEntry;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationToolbarWithIcon(R.mipmap.img_navbar_other);
    ...
    private void init() {
        ...
        othersEntry = (EditText) mCustomView.findViewById(R.id.content_text);
        othersEntry.requestFocus();
        othersEntry.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                InputMethodManager imm = (InputMethodManager) getSystemService(Context.INPUT_METHOD_SERVICE);
                imm.showSoftInput(othersEntry, InputMethodManager.SHOW_IMPLICIT);
            }
        });
        ...
        othersEntry.setText(mDotCategory.getNote());
        setDateEditInButton(mEntryDate);

        othersEntry.addTextChangedListener(new TextWatcher() {
            @Override
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        if (!othersEntry.getText().toString().equals(""))
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (!othersEntry.getText().toString().equals("")) {
            mDotCategory.setNote(othersEntry.getText().toString());
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.choose_time_button:
                showDateDialog(mDotCategory.getDate(), R.style.OtherStyleDialog);
                break;
        }
    }
}
