...
public class SlideDateTimePicker {
    ...
    public void setBackgroundTabColor(int backgroundTabColor) {
        mBackgroundTabColor = backgroundTabColor;
    }
    ...
    public static class Builder {
        ...
        public Builder setBackgroundTabColor(int backgroundTabColor) {
        ...
        public SlideDateTimePicker build() {
            ...
            picker.setBackgroundTabColor(backgroundTabColor);
